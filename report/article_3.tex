...
\affiliation{\textsuperscript{}\textit{}} % Author affiliation
\affiliation{\textsuperscript{}\textit{}} % Author affiliation
%\affiliation{\textbf{Corresponding author}: john@smith.com} % Corresponding author
\Keywords{scikit-learn\cite{sklearn} --- heat-maps\cite{heat-maps}} % Keywords - if you don't want any simply remove all the text between the curly brackets
